...
<table>
  <tr>
    ...
    <td width="33%" align="center">
      ...
      <p>Using AI, NLP, and intelligent systems to create tools that solve real problems.</p>
    </td>
  </tr>
</table>
...
I am open to **all data roles**, as well as **AI/ML Engineer**, **Computer Vision Engineer**, and **MLOps** opportunities.
...
<table>
  <tr>
    ...
    <td width="50%">
      <h3>Practical</h3>
      <p>I care about building things that can be used, tested, explained, and improved.</p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <h3>Curious</h3>
      <p>I am interested in AI, NLP, model behavior, robustness, and how intelligent systems can support decisions.</p>
    </td>
    <td width="50%">
      <h3>Growth-Oriented</h3>
      <p>I continuously improve my technical skills, communication, documentation, and project quality.</p>
    </td>
  </tr>
</table>
...
```yaml
currently:
  - Interning at ABA Technology in Casablanca
  - Strengthening my Data Science and AI engineering skills
  - Building better documentation habits
  - Improving ML, NLP, analytics, and deployment workflows
...
<img src="https://github-readme-activity-graph.vercel.app/graph?username=YOUSSEF-BT&theme=react-dark&hide_border=true&area=true" width="95%" />
...
I’m open to learning, building, collaborating, and contributing to meaningful data and AI projects.
...
### “Building practical data and AI systems — one step at a time.”
